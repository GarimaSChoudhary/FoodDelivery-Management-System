...
public class ViewDeliveryManJPanel extends javax.swing.JPanel {
    ...
    public ViewDeliveryManJPanel(JPanel container,DeliveryMan deliveryMan,DeliveryManDirectory deliveryManDirectory) {
        ...
        deliveryManNameTextField.setText(deliveryMan.getDeliveryName());
        deliveryManPhoneTextField.setText(deliveryMan.getDeliveryPhoneNo());
        deliveryManAddressTextField.setText(deliveryMan.getDeliveryAddress());
        image.setIcon(new ImageIcon(deliveryMan.getDeliveryPhoto()));
