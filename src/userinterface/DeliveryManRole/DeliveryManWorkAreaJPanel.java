...
public class DeliveryManWorkAreaJPanel extends javax.swing.JPanel {
        ...
        for(Order order: business.getOrderDirectory().getOrderDirectory()){
            if(order.getDeliveryMan() != null){
                ...
                Object[] row = new Object[7];
                    ...
                    row[5] = order.getCustomer().getCustomerAddress();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 58, 920, 96));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 160, -1, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setText("Update Delivery Details");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 30, -1, 20));
